...
class KioskCameraTestPage extends ConsumerStatefulWidget {
  const KioskCameraTestPage({super.key, this.type});

  final String? type;
  static String get routeName => 'cameraTest';

  @override
  KioskCameraTestState createState() => KioskCameraTestState();
}

class KioskCameraTestState extends ConsumerState<KioskCameraTestPage> {
  ...
  Future<void> _takePicture() async {
    logger.d(_cameras[_cameraIndex]);
    setState(() {
      _setCamera = true;
    });
  ...
  Widget build(BuildContext context) {
    final cameraState = ref.watch(kioskCameraProvider);
                    ...
                    ElevatedButton(
                      onPressed: () async {
                        if (_initialized) {
                          ...
                          await _initializeCamera();
                          await cameraState.setCameraId(_cameraId);
                        }
                      },
                      child: Text(
